...
export default function DashboardLayout({
  ...
  const navigation = [
    ...
    { name: 'Записи', href: '/dashboard/appointments', icon: ClipboardIcon },
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-zinc-50">
      ...
      <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
        <div className="flex-1 flex flex-col min-h-0 bg-white border-r border-zinc-200">
            ...
            >
              <item.icon
                className={`h-5 w-5 flex-shrink-0 ${
                  isActive ? 'text-indigo-600' : 'text-zinc-600 group-hover:text-zinc-700'
                }`}
              />
              {item.name}
            </Link>
